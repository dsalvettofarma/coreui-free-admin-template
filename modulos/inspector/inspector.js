...
import { loadLayout } from '../shared/layout.js'; // Solo layout por ahora
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        // Cargamos el layout sin verificar la sesión
        await loadLayout();
        console.log("INSPECTOR: Layout cargado correctamente");
